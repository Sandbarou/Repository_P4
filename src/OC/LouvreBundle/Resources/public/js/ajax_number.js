        ...
        $("select#visit_number.input-field.col.s12.form-control.initialized").change(function () {
            ...
            function fonctionDeRappel(data)
            {
                if (data === "Plus de tickets disponibles. Veuillez sélectionner une autre date. Merci.") {
                    //$("#panel2").removeClass('teal.lighten-2').addClass('red');
...
/*            $.ajax({
 method: "POST",
 url: 'http://localhost/newP4/web/app_dev.php/check/date/' + $(this).val(),
 ...
 $.ajax({
 method: "POST",
 url: 'http://localhost/newP4/web/app_dev.php/check/number/' + $(this).val(),
...
/*
 ...
 $.ajax({
 method: "POST",
 url: 'http://localhost/newP4/web/app_dev.php/check/15/55',
 /*            beforeSend: function () {
 console.log('ça charge !');
 },
 success: function (data) {
...
/*
 ...
 $.ajax({
 method: "POST",
 url: 'http://localhost/newP4/web/app_dev.php/get/number/' + $(this).val(),
 success: function (data) {
 console.log(data);
 }
 });
